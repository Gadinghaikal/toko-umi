<x-app-layout>
    ...
    <div class="page-header d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div>
            ...
            <h2 class="page-header-title">Edit Kategori: {{ $category->name }}</h2>
            <p class="page-header-subtitle">Perbarui informasi kategori yang sudah ada.</p>
        </div>
        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 fw-600" style="font-size: 0.95rem;">Formulir Edit Kategori</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('categories.update', $category->id) }}" method="POST" data-loading>
                        @csrf
                        @method('PUT')
